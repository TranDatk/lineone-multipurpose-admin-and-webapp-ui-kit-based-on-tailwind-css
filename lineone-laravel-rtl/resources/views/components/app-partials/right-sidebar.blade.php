    ...
    <div class="fixed left-0 top-0 z-[151] h-full w-full sm:w-80">
        <div x-data="{ activeTab: 'tabHome' }"
            ...
            <div class="flex items-center justify-between py-2 px-4">
                <p x-show="activeTab === 'tabHome'" class="flex shrink-0 items-center  space-x-reverse space-x-1.5">
                ...
                <p x-show="activeTab === 'tabProjects'" class="flex shrink-0 items-center  space-x-reverse space-x-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24"
                ...
                <p x-show="activeTab === 'tabActivity'" class="flex shrink-0 items-center  space-x-reverse space-x-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mt-4 px-3">
                    ...
                    <div class="mt-3 flex  space-x-reverse space-x-3">
                ...
                <div class="mt-4">
                    <div class="grid grid-cols-2 gap-3 px-3">
                        <div class="rounded-lg bg-slate-150 px-2.5 py-2 dark:bg-navy-600">
                            <div class="flex items-center justify-between  space-x-reverse space-x-1">
                                <p>
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center  space-x-reverse space-x-2">
                                <img class="size-10" src="{{ asset('images/200x200.png') }}"
                                    alt="image" />
                                <div>
                        ...
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center  space-x-reverse space-x-2">
                                <img class="size-10" src="{{ asset('images/200x200.png') }}" alt="image" />
                                <div>
                                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                                        SOL
                                    </h2>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-3 space-y-3 px-2">
                        <div
                            class="flex justify-between  space-x-reverse space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
            ...
            <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
                        <div class="flex justify-between  space-x-reverse space-x-1">
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    ...
                    <div class="mt-3 flex items-center justify-between  space-x-reverse space-x-2">
            ...
            <div x-show="activeTab === 'tabActivity'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mx-3 flex flex-col items-center rounded-lg bg-slate-100 py-3 px-8 dark:bg-navy-600">
                    ...
                    <button
                        class="btn mt-5  space-x-reverse space-x-2 rounded-full border border-slate-300 px-3 text-xs+ font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                ...
                <ol class="timeline line-space mt-5 px-4 [--size:1.5rem]">
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-item-content flex-1 pr-4">
                            ...
                            <a href="#"
                                class="inline-flex items-center  space-x-reverse space-x-1 pt-2 text-slate-600 transition-colors hover:text-primary dark:text-navy-100 dark:hover:text-accent">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
                <div
                    class="pointer-events-auto mx-auto flex  space-x-reverse space-x-1 rounded-full border border-slate-150 bg-white px-4 py-0.5 shadow-lg dark:border-navy-700 dark:bg-navy-900">
