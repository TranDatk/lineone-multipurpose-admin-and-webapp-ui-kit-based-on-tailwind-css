<div class="sidebar sidebar-panel print:hidden">
    <div class="flex h-full grow flex-col border-l border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-750">
                                        ...
                                        @foreach ($menu['submenu'] as $keyMenu => $submenu)
                                            <li
                                                ...
                                                <a href="{{ route($submenu['route_name']) }}"
                                                 ...
                                                 outline-none transition-[color,padding-right] duration-300 ease-in-out hover:pr-4
