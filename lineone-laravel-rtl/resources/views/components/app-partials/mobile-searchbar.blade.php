<div x-show="$store.breakpoints.isXs && $store.global.isSearchbarActive" x-transition:enter="easy-out transition-all"
    ...
    <div class="flex items-center  space-x-reverse space-x-2 bg-slate-100 px-3 pt-2 dark:bg-navy-800">
        <button
    ...
    <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
        <div class="is-scrollbar-hidden mt-3 flex  space-x-reverse space-x-4 overflow-x-auto px-3">
        ...
        <div class="mt-1 font-inter font-medium">
            <a class="group flex items-center  space-x-reverse space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
