<x-base-layout title="Chat App" is-sidebar-open="true" has-min-sidebar="true">
            ...
            <div class="flex h-full grow flex-col bg-white pr-[var(--main-sidebar-width)] dark:bg-navy-750">
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                        ...
                        <div class="swiper px-4" x-init="$nextTick(() => $el._x_swiper = new Swiper($el, { slidesPerView: 'auto', spaceBetween: 10, slidesPerGroup: 3 }))">
                            <div class="swiper-wrapper mt-1">
                                <div class="swiper-slide flex w-11 shrink-0 flex-col items-center justify-center">
                                    <div
                                        class="size-11 rounded-full bg-gradient-to-r from-purple-500 to-orange-600 p-0.5">
                    ...
                    <div class="mt-4 flex px-4">
                        <label class="relative ml-1.5 flex">
                            <input
                    ...
                    <div class="is-scrollbar-hidden mt-3 flex grow flex-col overflow-y-auto">
                        <div @click="$dispatch('change-active-chat',{chatId:'chat-1',avatar_url:'/images/200x200.png',name:'Alfredo Elliott'})"
                            class="flex cursor-pointer items-center  space-x-reverse space-x-2.5 px-4 py-2.5 font-inter hover:bg-slate-150 dark:hover:bg-navy-600">
                            ...
                            <div class="flex flex-1 flex-col">
                                <div class="flex items-baseline justify-between  space-x-reverse space-x-1.5">
                                ...
                                <div class="mt-1 flex items-center justify-between  space-x-reverse space-x-1">
    ...
    <main x-data="{ isShowChatInfo: !$store.breakpoints.mdAndDown, activeChat: { chatId: 'chat-1', name: 'Alfredo Elliott', avatar_url: '/images/200x200.png' } }" x-effect="$store.breakpoints.mdAndDown === true && (isShowChatInfo = false)"
        class="main-content h-100vh chat-app mt-0 flex w-full flex-col" :class="isShowChatInfo && 'lg:ml-80'"
        ...
        <div
            ...
            <div class="flex items-center  space-x-reverse space-x-5">
                ...
                <div @click="isShowChatInfo = true"
                    class="flex cursor-pointer items-center  space-x-reverse space-x-4 font-inter">
                    <div class="avatar">
                        <img class="rounded-full" src="null" :src="activeChat.avatar_url" alt="avatar" />
                    </div>
                    <div>
        ...
        <div :class="$store.breakpoints.smAndUp && 'scrollbar-sm'"
            ...
            <div x-show="activeChat.chatId === 'chat-1'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mx-4 flex items-center  space-x-reverse space-x-3">
                    <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
                    <p>Sunday</p>
                    <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
                </div>

                <div class="flex items-start  space-x-reverse space-x-2.5 sm:space-x-reverse sm:space-x-5">
                    <div class="avatar">
                        <img class="rounded-full" src="null" :src="activeChat.avatar_url" alt="avatar" />
                    </div>
                    ...
                    <div class="flex flex-col items-start space-y-3.5">
                        <div class="ml-4 max-w-lg sm:ml-10">
                            <div
                                class="rounded-2xl rounded-tr-none bg-white p-3 text-slate-700 shadow-sm dark:bg-navy-700 dark:text-navy-100">
                ...
                <div class="flex items-start justify-end  space-x-reverse space-x-2.5 sm:space-x-reverse sm:space-x-5">
                    <div class="flex flex-col items-end space-y-3.5">
                        <div class="mr-4 max-w-lg sm:mr-10">
                            <div
                                class="rounded-2xl rounded-tl-none bg-info/10 p-3 text-slate-700 shadow-sm dark:bg-accent dark:text-white">
        ...
        <div
            ...
            <div class="-ml-1.5 flex flex-1  space-x-reverse space-x-2">
                <button
            ...
            <div class="-ml-1.5 flex">
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5.5 rotate-180" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <template x-teleport="#x-teleport-target">
            <div x-data="{
                ...
                <div class="fixed left-0 top-0 z-[101] h-full w-full sm:w-80">
                    <div class="flex h-full w-full flex-col border-r border-slate-150 bg-white transition-transform duration-200 dark:border-navy-600 dark:bg-navy-750"
                        ...
                        <div class="flex h-[60px] items-center justify-between p-4">
                            ...
                            <div class="-ml-1.5 flex  space-x-reverse space-x-1">
                        ...
                        <div class="mt-5 flex flex-col items-center">
                            <div class="avatar size-20">
                                <img class="rounded-full" src="null" :src="activeChat.avatar_url"
                                    alt="avatar" />
                            </div>
                            <h3 x-text="activeChat.name"
                                class="mt-2 text-lg font-medium text-slate-700 dark:text-navy-100"></h3>
                            <p>Frontend Developer</p>
                            <div class="mt-2 flex  space-x-reverse space-x-1.5">
                                <button
