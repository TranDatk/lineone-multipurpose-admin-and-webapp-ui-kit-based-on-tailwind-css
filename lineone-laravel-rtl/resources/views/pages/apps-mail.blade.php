<x-base-layout title="Mail Application" is-sidebar-open="true" is-header-blur="true" has-min-sidebar="true">
            ...
            <div class="flex h-full grow flex-col bg-white pr-[var(--main-sidebar-width)] dark:bg-navy-750">
                ...
                <div class="flex h-18 w-full items-center justify-between pr-4 pl-1">
                    <div class="flex items-center">
                        <div class="avatar ml-3 hidden size-9 lg:flex">
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="is-scrollbar-hidden grow overflow-y-auto">
                        <div class="mt-2 px-4">
                            <button
                                class="btn w-full space-x-2 space-x-reverse rounded-full border border-slate-200 py-2 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-500 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                        ...
                        <ul class="mt-4 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex justify-between space-x-2 space-x-reverse rounded-lg bg-primary/10 p-2 tracking-wide text-primary outline-none transition-all dark:bg-accent-light/10 dark:text-accent-light"
                                    href="#">
                            ...
                            <li>
                                <a class="group flex justify-between space-x-2 space-x-reverse rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="#">
                                    <div class="flex items-center space-x-2 space-x-reverse">
                            ...
                            <li>
                                <a class="group flex justify-between space-x-2 space-x-reverse rounded-lg p-2 tracking-wide text-error outline-none transition-all hover:bg-error/20 focus:bg-error/20"
                                    href="#">
                                    <div class="flex items-center space-x-2 space-x-reverse">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5" fill="none"
                        ...
                        <ul class="mt-1 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="size-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200"
    ...
    <main class="main-content mail-app w-full px-[var(--margin-x)] pb-6">
        <div class="flex flex-col-reverse py-5 sm:flex-row sm:justify-between">
            <div class="mt-2 flex items-center justify-between space-x-1 space-x-reverse">
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">All</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">None</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Read</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Starred</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Unread</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Unstarred</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="card">
            <div
                ...
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2 space-x-reverse sm:w-72">
                        <div class="flex">
                            <label class="flex size-8 items-center justify-center" x-tooltip="'Select'">
                                <input
                                    class="form-checkbox is-outline size-4.5 rounded border-slate-400/70 before:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:before:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent"
                                    type="checkbox" />
                            </label>
                ...
                <div class="flex flex-1 items-center justify-between space-x-2 space-x-reverse">
                    <div class="flex items-center space-x-2 space-x-reverse px-2">
    ...
    <div class="fixed left-3 bottom-3 rounded-full bg-white dark:bg-navy-700">
        <button
