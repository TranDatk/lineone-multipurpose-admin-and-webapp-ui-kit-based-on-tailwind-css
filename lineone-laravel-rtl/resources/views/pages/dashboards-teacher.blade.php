        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                <div :class="$store.breakpoints.smAndUp && 'via-purple-300'"
                    class="card mt-12 bg-gradient-to-r from-pink-300 to-indigo-400 p-5 sm:mt-0 sm:flex-row">
                    <div class="flex justify-center sm:order-last">
                        <img class="-mt-16 h-40 sm:mt-0" src="{{ asset('images/illustrations/teacher.svg') }}"
                            alt="" />
                    </div>
                    <div class="mt-2 flex-1 pt-2 text-center text-white sm:mt-0 sm:text-right">
                        <h3 class="text-xl">
                            ...
                            <table class="is-hoverable w-full text-right">
                                ...
                                <tbody>
                                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div
                                                class="badge space-x-2.5 space-x-reverse text-slate-800 dark:text-navy-100">
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div
                                                class="badge space-x-2.5 space-x-reverse text-secondary dark:text-secondary-light">
                                                <div class="size-2 rounded-full bg-current"></div>
                                                <span>Can Edit</span>
                                            </div>
                                        </td>
