        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2 space-x-reverse">
                ...
                <div
                    class="flex divide-x divide-x-reverse divide-slate-150 border-t border-slate-150 dark:divide-navy-500 dark:border-navy-500">
                    <button
                        class="btn h-11 w-full rounded-none rounded-br-lg font-medium text-slate-700 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25">
                        Profile
                    </button>
                    <button
                        class="btn h-11 w-full rounded-none rounded-bl-lg font-medium text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
                        Chat
                    </button>
                </div>
            </div>
