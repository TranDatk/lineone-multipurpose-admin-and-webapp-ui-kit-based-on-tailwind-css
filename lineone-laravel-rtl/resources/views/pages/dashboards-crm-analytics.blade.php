    ...
    <main class="main-content w-full pb-8">
        <div
            ...
            <div class="col-span-12 lg:col-span-8">
                ...
                <div class="flex flex-col sm:flex-row sm:space-x-7 sm:space-x-reverse">
                    <div class="mt-4 flex shrink-0 flex-col items-center sm:items-start">
                        ...
                        <button
                            class="btn mt-8 space-x-2 space-x-reverse rounded-full border border-slate-300 px-3 text-xs+ font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                ...
                <div class="grid grid-cols-1 gap-y-4 pb-3 sm:grid-cols-3">
                    <div class="flex flex-col justify-between border-4 border-transparent border-l-info px-4">
                        ...
                        <div>
                            ...
                            <div class="mt-8 flex items-center justify-between space-x-2 space-x-reverse">
                    ...
                    <div class="flex flex-col justify-between border-4 border-transparent border-l-warning px-4">
                        <div>
                            ...
                            <div class="mt-2 flex space-x-1.5 space-x-reverse">
            ...
            <div class="col-span-12 lg:col-span-4">
                ...
                <div class="mt-4 flex h-2 space-x-1 space-x-reverse">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div
                class="col-span-12 flex flex-col px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-3 lg:pl-0">
                <h2
                ...
                <div class="mt-4">
                    <p>Sales Growth</p>
                    <div class="mt-1.5 flex items-center space-x-2 space-x-reverse">
            ...
            <div
                class="is-scrollbar-hidden col-span-12 flex space-x-4 space-x-reverse overflow-x-auto px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-9 lg:pr-0">
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="grow">
                        <div class="flex w-full space-x-1 space-x-reverse">
                        ...
                        <div class="mt-2 flex flex-wrap">
                            <div class="ml-4 mb-1 inline-flex items-center space-x-2 space-x-reverse font-inter">
                                <div class="size-2 rounded-full bg-primary dark:bg-accent"></div>
                                <div class="flex space-x-1 space-x-reverse text-xs leading-6">
                            ...
                            <div class="ml-4 mb-1 inline-flex items-center space-x-2 space-x-reverse font-inter">
                                ...
                                <div class="flex space-x-1 space-x-reverse text-xs">
                                    <span class="font-medium text-slate-700 dark:text-navy-100">Chat Messages</span>
                                    <span>17%</span>
                                </div>
                            </div>
                            <div class="mb-1 inline-flex items-center space-x-2 space-x-reverse font-inter">
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="grow">
                        <div class="flex w-full space-x-1 space-x-reverse">
                            ...
                            <div x-tooltip="'Chats Messages'" class="w-2/12 rounded-full bg-success"></div>
        ...
        <div
            ...
            <div class="card col-span-12 sm:col-span-6">
                ...
                <div class="ax-transparent-gridline ax-rounded-b-lg">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.analyticsBandwidth);
                        $el._x_chart.render() });"></div>
                </div>
            </div>
