    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card col-span-12 pb-4">
                <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="hidden cursor-pointer items-center space-x-2 space-x-reverse sm:flex">
                        ...
                        <select
                            class="form-select h-8 rounded-full border border-slate-300 bg-white px-2.5 pl-9 text-xs+ hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
            ...
            <div class="col-span-12 xl:col-span-7">
                <div class="card">
                    <div
                        class="grid grid-cols-1 divide-y divide-slate-150 dark:divide-navy-500 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:divide-x-reverse">
