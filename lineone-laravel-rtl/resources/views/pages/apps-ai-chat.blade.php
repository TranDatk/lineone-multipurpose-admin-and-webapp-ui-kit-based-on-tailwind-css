<x-base-layout title="Ai Chat App" has-min-sidebar="true">
    <!-- Sidebar -->
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    ...
                    <div class="flex flex-col grow overflow-hidden">
                        <div class="flex min-w-0 items-center justify-between px-4">
                            <span class="truncate text-tiny+ font-medium uppercase">Recent Chats</span>
                            <button
                                class="btn -ml-1.5 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div class="overflow-y-auto is-scrollbar-hidden min-w-0 px-2 pt-1">
                            <div role="button"
                                class="group flex space-x-2 space-x-reverse w-full min-w-0 items-start justify-start p-2 text-xs+ rounded-lg tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"
                                ...
                                <div class="-mt-px flex min-w-0 flex-1 items-center justify-between gap-2 text-start">
                                    ...
                                    <button
                                        class="btn p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 opacity-0 size-5 rounded-full group-hover:opacity-100 group-focus:opacity-100 -ml-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
    ...
    <main class="main-content chat-app h-100vh mt-0 flex flex-col w-full min-w-0 supports-[height:1dvh]:h-dvh">
        <div
            ...
            <div class="flex min-w-0 items-center gap-1">
                ...
                <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="isShowPopper && (isShowPopper = false)"
                    class="inline-flex">
                    <button
                        class="btn space-x-2 space-x-reverse font-medium text-slate-700 hover:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25"
                    ...
                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                        <div
                            ...
                            <ul>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">ChatGPT
                                        3</a>
                                </li>
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot
                                        Pro</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="flex space-x-3 space-x-reverse items-center">
                ...
                <button
                    class="btn space-x-2 space-x-reverse bg-gradient-to-r from-green-400 to-blue-600 font-medium text-white">
        ...
        <div :class="$store.breakpoints.smAndUp && 'scrollbar-sm'"
            class="overflow-y-auto mx-auto w-full max-w-screen-lg xl:px-12 grow space-y-8 py-4">
            <div class="px-4 pt-6 text-[clamp(2.2rem,3.75vw,3.75rem)] font-medium leading-[1.1] tracking-tight">
                <span
                    class="block animate-shimmer bg-gradient-to-r from-violet-400 via-red-400 to-fuchsia-400 bg-clip-text font-semibold text-transparent"
            ...
            <div class="space-y-8 pt-6 lg:pt-12 px-2 sm:px-4">
                <div class="space-y-4">
                    <div class="flex items-end justify-end gap-2.5 mr-4 sm:mr-10">
                        <div
                            class="relative break-words print:border max-w-lg rounded-2xl rounded-bl bg-slate-150 p-3 dark:bg-navy-700">
                            Do you have emotions?
                        </div>
                    ...
                    <div class="flex items-end justify-start gap-2.5 ml-4 sm:ml-10">
                        ...
                        <div
                            class="relative break-words print:border rounded-br w-full max-w-lg rounded-2xl border border-slate-200 p-3 dark:border-navy-600">
                            <div class="text-sm+">
                                I can't feel emotions myself, but I can understand and
                                respond to yours! Tell me how you're feeling today.
                            </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-end justify-end gap-2.5 mr-4 sm:mr-10">
                        <div
                            class="relative break-words print:border max-w-lg rounded-bl rounded-2xl bg-slate-150 p-3 dark:bg-navy-700">
                            Will robots take over the world?
                        </div>
                        <div class="avatar max-sm:hidden">
                    ...
                    <div class="flex items-end justify-start gap-2.5 ml-4 sm:ml-10">
                        ...
                        <div
                            class="relative break-words print:border w-full max-w-lg rounded-br rounded-2xl border border-slate-200 p-3 dark:border-navy-600">
                            <div class="text-sm+">
                                Science fiction is fun, but AI's purpose is to assist
                ...
                <div class="space-y-4">
                    <div class="flex items-end justify-end gap-2.5 mr-4 sm:mr-10">
                        <div
                            class="relative break-words print:border rounded-bl max-w-lg rounded-2xl bg-slate-150 p-3 dark:bg-navy-700">
                            What's your favorite color?
                        </div>
                        <div class="avatar max-sm:hidden">
                            <img class="rounded-full" src="{{ asset('images/200x200.png') }}" alt="avatar" />
        ...
        <div class="mx-auto w-full max-w-screen-lg xl:px-16 px-3 sm:px-4 pb-4">
            <div
