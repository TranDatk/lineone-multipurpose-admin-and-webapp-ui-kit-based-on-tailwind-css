<x-app-layout title="Help 3" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="relative flex flex-col items-center justify-center">
            <div class="absolute left-0 top-0 -mt-8 hidden max-w-xs p-4 lg:block">
            ...
            <div class="space-y-20">
                <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
                    <div class="flex justify-center">
                        <img class="w-full max-w-xs" src="{{ asset('images/illustrations/rocket.svg') }}"
                            alt="image" />
                    </div>
                    <div class="w-full">
                ...
                <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
                    <div class="flex justify-center lg:order-last">
                        <img class="w-full max-w-xs" src="{{ asset('images/illustrations/mobile-app.svg') }}"
                            alt="image" />
                    </div>
                    <div class="w-full">
                        <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
                ...
                <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
                    <div class="flex justify-center">
                        <img class="w-full max-w-xs" src="{{ asset('images/illustrations/credit-card.svg') }}"
                            alt="image" />
                    </div>
                    <div class="w-full">
                        <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
