            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div>
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <button
                                class="btn rounded-r-full rounded-l-none border border-warning font-medium text-warning hover:bg-warning hover:text-white focus:bg-warning focus:text-white active:bg-warning/90">
                                First
                            </button>
                            <button
                            ...
                            <button
                                class="btn rounded-r-none rounded-l-full border border-warning font-medium text-warning hover:bg-warning hover:text-white focus:bg-warning focus:text-white active:bg-warning/90">
                                Third
                            </button>
                        </div>
                    </div>
