        ...
        <div class="sidebar-panel">
            <div class="flex h-full grow flex-col bg-white pr-[var(--main-sidebar-width)] dark:bg-navy-750">
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    ...
                    <div class="flex items-center space-x-3 space-x-reverse p-4">
                        <div
            ...
            <div class="hidden sm:col-span-6 sm:block lg:col-span-4">
                            ...
                            <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                                <div
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"
                                                class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Draft
                                                #001</a>
                                        </li>
                                        <li>
                                            <a href="#"
                ...
                <div class="card mt-5 p-4 sm:p-5">
                    <div class="flex flex-col space-y-3.5">
                        <div class="group flex items-center justify-between space-x-3 space-x-reverse">
    ...
    <div x-data="{ showDrawer: false }" x-show="showDrawer" x-effect="$store.breakpoints.smAndUp && (showDrawer = false)"
        ...
        <div class="fixed right-0 bottom-0 z-[101] h-[calc(100%-2.5rem)] w-full">
            <div class="flex h-full w-full flex-col rounded-t-2xl bg-white px-4 py-3 transition-transform duration-200 dark:bg-navy-700"
                ...
                <div class="flex items-center justify-between">
                    <div class="-ml-1 flex items-center space-x-1.5 space-x-reverse">
                    ...
                    <div class="-mr-1.5 flex space-x-1 space-x-reverse">
                        <button
                            class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
