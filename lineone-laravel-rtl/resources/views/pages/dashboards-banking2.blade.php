        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4">
                    <div class="px-4 text-white sm:px-5">
                        <div class="-mt-1 flex items-center space-x-reverse space-x-2">
                        ...
                        <div class="mt-4 flex space-x-reverse space-x-7">
                            <div>
                ...
                <div class="col-span-12 mt-5 sm:col-span-6 sm:mt-0 lg:col-span-8">
                    <div class="swiper px-5 sm:pr-0" x-init="$nextTick(() => new Swiper($el, { slidesPerView: 'auto', spaceBetween: 16 }))">
            ...
            <div class="card group col-span-12 pb-5 lg:col-span-8">
                <div class="my-3 flex flex-col justify-between px-4 sm:flex-row sm:items-center sm:px-5">
                    <div class="flex flex-1 items-center justify-between space-x-reverse space-x-2 sm:flex-initial">
                    ...
                    <div class="flex items-center space-x-reverse space-x-4">
                        <div class="flex cursor-pointer items-center space-x-reverse space-x-2">
            ...
            <div class="card col-span-12 px-4 pb-5 sm:px-5 lg:col-span-4">
                ...
                <div class="mt-2 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1.5 flex h-9 space-x-reverse -space-x-px">
                            <select
                                class="form-select rounded-r-lg border border-slate-300 bg-white px-3 py-2 pl-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                <option>$</option>
                                <option>£</option>
                                <option>€</option>
                            </select>
