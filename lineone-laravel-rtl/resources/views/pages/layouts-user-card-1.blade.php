    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between py-5 lg:py-6">
            ...
            <div class="flex items-center space-x-2 space-x-reverse">
                <label class="relative hidden sm:flex">
                    <input
                        class="form-input peer h-9 w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pr-9 text-xs+ placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    ...
                    <div class="mt-6 grid w-full grid-cols-2 gap-2">
                        <button
                            class="btn space-x-2 space-x-reverse bg-primary px-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                        ...
                        <button
                            class="btn space-x-2 space-x-reverse bg-slate-150 px-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4 shrink-0" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar size-20">
                        <img class="mask is-reuleaux-triangle" src="{{ asset('images/200x200.png') }}"
                            alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Katrina West
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar size-20">
                        <img class="mask is-diamond" src="{{ asset('images/200x200.png') }}"
                            alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Raul Bradley
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar size-20">
                        <img class="mask is-hexagon-2" src="{{ asset('images/200x200.png') }}"
                            alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Corey Evans
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar size-20">
                        <img class="mask is-star-2" src="{{ asset('images/200x200.png') }}"
                            alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Anthony Jensen
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar size-20">
                        <img class="mask is-octagon" src="{{ asset('images/200x200.png') }}"
                            alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Joe Perkins
