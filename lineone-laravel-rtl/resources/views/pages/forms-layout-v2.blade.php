            ...
            <div class="col-span-12 grid lg:col-span-4 lg:place-items-center">
                <div>
                    <ol class="steps is-vertical line-space [--size:2.75rem] [--line:.5rem]">
                        <li class="step space-x-4 space-x-reverse pb-12 before:bg-slate-200 dark:before:bg-navy-500">
                        ...
                        <li class="step space-x-4 space-x-reverse before:bg-slate-200 dark:before:bg-navy-500">
                            <div
                                class="step-header mask is-hexagon bg-slate-200 text-slate-500 dark:bg-navy-500 dark:text-navy-100">
            ...
            <div class="col-span-12 grid lg:col-span-8">
                <div class="card">
                    ...
                    <div class="space-y-4 p-4 sm:p-5">
                        ...
                        <div class="flex justify-center space-x-2 space-x-reverse pt-4">
                            <button
