            ...
            <div class="card px-4 pb-6 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-6">
                        <label class="block">
                            <input value="50" class="form-range text-primary dark:text-accent" type="range" />
                        </label>
                        <label class="block">
                            <input value="50" class="form-range text-secondary dark:text-secondary-light"
                                type="range" />
                        </label>
                        <label class="block">
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div x-data="{ range: 50 }" class="mt-5">
                        ...
                        <label class="block">
                            <input x-model="range" class="form-range text-slate-500 dark:text-navy-300"
                                type="range" />
                        </label>
                        <div class="mt-2">
