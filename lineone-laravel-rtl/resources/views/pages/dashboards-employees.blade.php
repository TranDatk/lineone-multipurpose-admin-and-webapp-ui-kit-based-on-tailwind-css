            ...
            <div class="card flex-row justify-between p-4 sm:flex-col lg:flex-row">
                <div class="flex flex-col justify-between">
                    <div class="space-y-2 pb-2">
                        ...
                        <div
                            class="badge h-6 space-x-1 space-x-reverse rounded-full bg-info/10 text-info dark:bg-info/15">
                    ...
                    <p class="flex space-x-1 space-x-reverse text-xs sm:hidden lg:flex">
