    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card p-4">
                    <div class="flex -space-x-px space-x-reverse">
                        <input
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card flex-row space-x-4 space-x-reverse p-3">
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex flex-wrap -space-x-2 space-x-reverse">
                ...
                <div
                    class="flex space-x-4 space-x-reverse sm:space-x-5 sm:space-x-reverse lg:space-x-6 lg:space-x-reverse">
                ...
                <div class="card flex-row items-center space-x-4 space-x-reverse p-4">
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card space-y-4 p-4 sm:p-5">
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 bg-transparent dark:border-navy-400"></div>
                        <p>Not Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 border-primary bg-transparent dark:border-accent"></div>
                        <p>Primary Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div
                            class="size-5 rounded border-2 border-secondary bg-transparent dark:border-secondary-light">
                        </div>
                        <p>Secondary Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 border-info bg-transparent"></div>
                        <p>Info Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 border-success bg-transparent"></div>
                        <p>Success Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 border-warning bg-transparent"></div>
                        <p>Warning Color</p>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <div class="size-5 rounded border-2 border-error bg-transparent"></div>
                        <p>Error Color</p>
                    </div>
                </div>
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-4 flex h-1.5 space-x-1 space-x-reverse">
                    ...
                    <div class="inline-space mt-3 flex flex-wrap">
                        <div class="badge space-x-2.5 space-x-reverse p-0 text-primary dark:text-accent-light">
                            <div class="size-2 rounded-full bg-current"></div>
                            <span>HTML</span>
                        </div>
                        <div class="badge space-x-2.5 space-x-reverse p-0 text-secondary dark:text-secondary-light">
                            <div class="size-2 rounded-full bg-current"></div>
                            <span>CSS</span>
                        </div>
                        <div class="badge space-x-2.5 space-x-reverse p-0 text-success">
                            <div class="size-2 rounded-full bg-current"></div>
                            <span>JavaScript</span>
                        </div>
                        <div class="badge space-x-2.5 space-x-reverse p-0 text-warning">
                            <div class="size-2 rounded-full bg-current"></div>
                            <span>Vue</span>
                        </div>
                        <div class="badge space-x-2.5 space-x-reverse p-0 text-error">
                            <div class="size-2 rounded-full bg-current"></div>
                            <span>Go</span>
                        </div>
                    </div>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card flex-row justify-between p-4 sm:p-5">
                    <div>
                        ...
                        <div class="mt-4 flex items-baseline space-x-1 space-x-reverse">
                ...
                <div class="card">
                    ...
                    <div class="is-scrollbar-hidden flex space-x-4 space-x-reverse overflow-x-auto px-5 pb-4 sm:px-5">
                        <div class="text-center">
                            <div class="avatar size-10">
                                <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                    alt="avatar" />
