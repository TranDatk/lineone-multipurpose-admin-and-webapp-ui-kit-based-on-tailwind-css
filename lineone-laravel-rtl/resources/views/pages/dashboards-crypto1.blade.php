        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="col-span-12 lg:col-span-8">
                <div class="card bg-gradient-to-br from-purple-500 to-indigo-600 px-4 pb-4 sm:px-5">
                    <div class="flex items-center justify-between py-3 text-white">
                        ...
                        <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                            ...
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="btn -ml-1.5 size-8 rounded-full p-0 hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                        <div>
                            <div class="flex w-9/12 items-center space-x-1 space-x-reverse">
                ...
                <div class="card mt-4 pb-1 sm:mt-5 lg:mt-6">
                    ...
                    <div
                        class="scrollbar-sm flex space-x-4 space-x-reverse overflow-x-auto overflow-y-hidden px-4 pb-2 sm:px-5">
                        <div class="flex w-72 shrink-0 flex-col">
                            <div class="flex items-center space-x-2 space-x-reverse">
                                <img class="size-6" src="{{ asset('images/200x200.png') }}" alt="flag" />
                                <div>
                                    <span>Bitcoin</span>
                            ...
                            <div class="mt-2.5 flex justify-between rounded-lg bg-slate-50 py-3 pl-3 dark:bg-navy-600">
                                ...
                                <div
                                    ...
                                    <p class="mt-1 flex items-center space-x-0.5 space-x-reverse text-xs text-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M7 11l5-5m0 0l5 5m-5-5v12" />
                        ...
                        <div class="flex w-72 shrink-0 flex-col">
                            ...
                            <div class="mt-2.5 flex justify-between rounded-lg bg-slate-50 py-3 pl-3 dark:bg-navy-600">
                                ...
                                <div
                                    ...
                                    <p class="mt-1 flex items-center space-x-0.5 space-x-reverse text-xs text-error">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M17 13l-5 5m0 0l-5-5m5 5V6" />
            ...
            <div class="col-span-12 grid grid-cols-1 gap-4 sm:gap-5 lg:col-span-4 lg:gap-6">
                <div class="card pb-4">
                    ...
                    <div class="scrollbar-sm flex space-x-3 space-x-reverse overflow-x-auto px-4 pb-3 sm:px-5">
                        <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-amber-400 to-orange-600 p-[3px]">
                            <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                                <div class="flex items-center justify-between">
                                    <p>Bitcoin</p>
                                    <img src="{{ asset('images/200x200.png') }}" class="size-6"
                                        alt="logo" />
                                </div>
                    ...
                    <div class="px-4 sm:px-5">
                            ...
                            <div
                                ...
                                <div class="tabs-list flex px-1.5 py-1">
                                    <button @click="activeTab = 'tabReceive'"
                                        ...
                                        class="btn flex-1 space-x-2 space-x-reverse px-3 py-2 font-medium">
                        ...
                        <div class="relative">
                            <div class="pt-4">
                                ...
                                <div
                                    class="mt-1 flex justify-between space-x-2 space-x-reverse rounded-2xl bg-slate-150 p-1.5 dark:bg-navy-800">
                                    <select
                                    ...
                                    <input
                                        class="form-input w-full bg-transparent px-2 text-left placeholder:text-slate-400/70"
                            ...
                            <div class="absolute left-0 top-1/2 mt-1">
                                <button
