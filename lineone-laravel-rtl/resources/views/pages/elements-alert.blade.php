            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="alert flex rounded-lg bg-primary px-4 py-4 text-white dark:bg-accent sm:px-5">
                            This is simple alert
                        </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="alert flex rounded-lg border border-info px-4 py-4 text-info sm:px-5">
                            This is simple alert
                        </div>

                        <div class="alert flex rounded-lg border border-success px-4 py-4 text-success sm:px-5">
                            This is simple alert
                        </div>

                        <div class="alert flex rounded-lg border border-warning px-4 py-4 text-warning sm:px-5">
                            This is simple alert
                        </div>

                        <div class="alert flex rounded-lg border border-error px-4 py-4 text-error sm:px-5">
                            This is simple alert
                        </div>
                    </div>
                </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="alert flex rounded-full bg-info/10 py-4 px-4 text-info dark:bg-info/15 sm:px-5">
                            This is simple alert
                        </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div
                            class="alert flex space-x-2 space-x-reverse rounded-lg border border-error px-4 py-4 text-error">
            ...
            <div class="card px-4 pb-4 sm:px-5 lg:col-span-2">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div x-data="{ isShow: true }" data-alert-root
                            ...
                            <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                ...
                                <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                    class="btn -ml-1.5 size-7 shrink-0 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                                    <div
                                        ...
                                        <ul>
                                            <li>
                                                <a @click="isShow = false; setTimeout(()=>$el.closest('[data-alert-root]').remove(),300)"
                                                    href="javascript:void(0);"
                                                    class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Remove</a>
                                            </li>
                                            <li>
                                                <a href="#"
