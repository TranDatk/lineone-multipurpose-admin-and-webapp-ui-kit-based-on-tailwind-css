    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4 lg:gap-6">
                <div class="card flex-row justify-between p-4">
                    <div>
                        ...
                        <div class="mt-8 flex items-baseline space-x-1 space-x-reverse">
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2 lg:gap-6">
                <div>
                    <div class="flex h-8 items-center justify-between">
                        ...
                        <select
                            class="form-select h-8 rounded-full border border-slate-300 bg-slate-50 px-2.5 pl-9 text-xs+ hover:border-slate-400 focus:border-primary dark:border-navy-600 dark:bg-navy-900 dark:hover:border-navy-400 dark:focus:border-accent">
            ...
            <div class="flex flex-col rounded-xl bg-info/10 py-5 dark:bg-navy-800 lg:flex-row">
                ...
                <div
                    class="scrollbar-sm mt-5 flex space-x-4 space-x-reverse overflow-x-auto px-4 sm:px-5 lg:mt-0 lg:pr-0">
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="{{ asset('images/200x200.png') }}"
                            alt="flag" />
                        ...
                        <div class="card -mt-5 w-full rounded-2xl px-3 py-5 text-center">
                            ...
                            <div class="mt-6 flex justify-center space-x-1 space-x-reverse font-inter">
