                ...
                <div class="max-w-xl">
                    <p>
                        ...
                        <a class="font-normal text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent"
                            href="https://github.com/nosir/cleave.js">Github</a>
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                      ...
                      uppercase: true
                                ...
                                class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="xxx.xx_xxx-xxx" type="text" />
                        </label>
                    </div>
                </div>
                <div dir="ltr" class="code-wrapper hidden pt-4">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-4">
                      ...
                      timePattern: ['h', 'm', 's']
                                    ...
                                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter Time" type="text" />
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        ...
                        <label class="mt-1.5 flex -space-x-px space-x-reverse">
                            <span
                                class="flex shrink-0 items-center justify-center rounded-r-lg border border-slate-300 px-3.5 font-inter dark:border-navy-450">
                                <span>US (+1)</span>
                            </span>
                            <input
                                x-input-mask="{
