            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    error:()=>$notification({text:'Error',variant:'error'})
                                ...
                                class="btn z-2 rounded-r-none bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                Copy
                            </button>
                        </div>
                    </div>
