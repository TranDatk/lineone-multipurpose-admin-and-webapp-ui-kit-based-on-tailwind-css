                ...
                <div class="max-w-xl">
                    <p>
                        ...
                        <a class="font-normal text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent"
                            href="https://github.com/mattkingshott/iodine">Github</a>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input
                                    ...
                                    x-model="username.value" @blur="username.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="username.blurred && username.errorMessage"
                                x-text="username.errorMessage"></span>
                        </div>

                        <div>
                            <label class="block">
                                <span>Email Value </span>
                                <input x-effect="email.errorMessage = getErrorMessage(email.value, email.validate)"
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    ...
                                    x-model="email.value" @blur="email.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="email.blurred && email.errorMessage"
                                x-text="email.errorMessage"></span>
                        </div>

                        <div>
                            <label class="block">
                                <span>Min/Max </span>
                                <input x-effect="minmax.errorMessage = getErrorMessage(minmax.value, minmax.validate)"
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    placeholder="Number between 5 - 15" type="text"
                                    :class="{
                                        'border-slate-300 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent':
                                            !minmax.blurred,
                                    ...
                                    x-model="minmax.value" @blur="minmax.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="minmax.blurred && minmax.errorMessage"
                                x-text="minmax.errorMessage"></span>
                        </div>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input
                                    ...
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    placeholder="String length between 5 to 15" type="text"
                                    :class="{
                                        'border-slate-300 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent':
                                            !minmaxLength.blurred,
                                        'border-error': (minmaxLength.blurred && minmaxLength.errorMessage),
                                        'border-success': (minmaxLength.blurred && !minmaxLength.errorMessage)
                                    }"
                                    x-model="minmaxLength.value" @blur="minmaxLength.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error"
                                x-show="minmaxLength.blurred && minmaxLength.errorMessage"
                                x-text="minmaxLength.errorMessage"></span>
                        </div>

                        <div>
                            <label class="block">
                                <span>URL Address</span>
                                <input x-effect="url.errorMessage = getErrorMessage(url.value, url.validate)"
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    placeholder="Only URL" type="text"
                                    :class="{
                                        'border-slate-300 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent':
                                            !url.blurred,
                                    ...
                                    x-model="url.value" @blur="url.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="url.blurred && url.errorMessage"
                                x-text="url.errorMessage"></span>
                        </div>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input
                                    ...
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    placeholder="Instagram Username" type="text"
                                    :class="{
                                        'border-slate-300 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent':
                                            !instagramUsername.blurred,
                                    ...
                                    x-model="instagramUsername.value" @blur="instagramUsername.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error"
                                x-show="instagramUsername.blurred && instagramUsername.errorMessage"
                                x-text="instagramUsername.errorMessage"></span>
                        </div>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input
                                    ...
                                    class="form-input mt-1.5 w-full rounded-lg border bg-transparent px-3 py-2 placeholder:text-slate-400/70"
                                    placeholder="Start With A" type="text"
                                    :class="{
                                        'border-slate-300 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent':
                                            !startWith.blurred,
                                    ...
                                    x-model="startWith.value" @blur="startWith.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="startWith.blurred && startWith.errorMessage"
                                x-text="startWith.errorMessage"></span>
                        </div>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input
                                    ...
                                    x-model="endWith.value" @blur="endWith.blurred = true" />
                            </label>
                            <span class="text-tiny+ text-error" x-show="endWith.blurred && endWith.errorMessage"
                                x-text="endWith.errorMessage"></span>
                        </div>
                    </div>
                </div>
