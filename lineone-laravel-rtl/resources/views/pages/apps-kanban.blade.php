<x-base-layout title="Kanban Board" is-sidebar-open="true" has-min-sidebar="true">
    ...
    <main class="main-content kanban-app w-full">
        <div
            class="flex items-center justify-between space-x-2 space-x-reverse px-[var(--margin-x)] py-5 transition-all duration-[.25s]">
            ...
            <label class="relative hidden w-full max-w-[16rem] sm:flex">
                <input
                    class="form-input peer h-8 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 text-xs+ placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
        ...
        <div class="flex h-[calc(100vh-8.5rem)] grow flex-col">
            <div x-init="Sortable.create($el, {
                ...
                class="kanban-scrollbar grow flex w-full items-start space-x-4 space-x-reverse overflow-x-auto overflow-y-hidden px-[var(--margin-x)] transition-all duration-[.25s]">
                <div class="board-draggable relative flex max-h-full w-72 shrink-0 flex-col">
                    ...
                    <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="flex space-x-3 space-x-reverse px-2.5 pb-2 pt-1.5">
                                ...
                                <div class="flex-1 space-y-2">
                                    ...
                                    <div class="flex flex-wrap space-x-1 space-x-reverse">
                                        <div
                                            class="badge space-x-1 space-x-reverse bg-slate-150 py-1 px-1.5 text-slate-800 dark:bg-navy-500 dark:text-navy-100">
                                        ...
                                        <div
                                            class="badge space-x-1 space-x-reverse bg-info/10 py-1 px-1.5 text-info dark:bg-info/15">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 13l4 4L19 7" />
                                    ...
                                    <div class="flex items-end justify-between pt-1">
                                        <div class="flex flex-wrap -space-x-1.5 space-x-reverse">
                                        ...
                                        <div
                                            class="flex items-center space-x-2 space-x-reverse text-xs text-slate-400 dark:text-navy-300">
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="space-y-2 px-2.5 pb-2 pt-1.5">
                                ...
                                <div class="flex flex-wrap space-x-1 space-x-reverse">
                                    ...
                                    <div
                                        class="badge space-x-1 space-x-reverse bg-error/10 py-1 px-1.5 text-error dark:bg-error/15">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5 13l4 4L19 7" />
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="space-y-3 rounded-lg bg-success/10 px-2.5 pb-2 pt-1.5">
                                ...
                                <div class="flex flex-wrap space-x-1 space-x-reverse">
                                    <div
                                        class="badge space-x-1 space-x-reverse bg-success/10 py-1 px-1.5 text-success dark:bg-success/15">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    ...
                    <div class="flex justify-center py-2">
                        <button
                            class="flex items-center justify-center space-x-2 space-x-reverse font-medium text-slate-600 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="px-2.5 pb-2 pt-1.5">
                                ...
                                <div class="mt-2 flex flex-wrap space-x-1 space-x-reverse">
                                    <div
                                        class="badge space-x-1 space-x-reverse bg-slate-150 py-1 px-1.5 text-slate-800 dark:bg-navy-500 dark:text-navy-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="rounded-lg bg-warning/10 px-2.5 pb-2 pt-1.5">
                                ...
                                <div class="mt-2 flex flex-wrap space-x-1 space-x-reverse">
                                    <div
                                        class="badge space-x-1 space-x-reverse bg-warning/10 py-1 px-1.5 text-warning dark:bg-warning/15">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                ...
                <div class="board-draggable relative flex max-h-full w-72 shrink-0 flex-col">
                    ...
                    <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5"
                        ...
                        <div class="card cursor-pointer shadow-sm">
                            <div class="flex space-x-3 space-x-reverse rounded-lg bg-error/10 px-2.5 pb-2 pt-1.5">
                                <div class="w-10 shrink-0 py-1">
    ...
    <div x-show="showDrawer" x-data="{ showDrawer: false }"
        ...
        <div class="fixed left-0 top-0 z-[101] h-full w-full sm:w-80">
                    ...
                    <div x-data="{ expanded: true }">
                        ...
                        <div x-show="expanded" x-collapse>
                            <ul class="mt-2 space-y-3 px-4 font-inter font-medium">
                                <li>
                                    <a class="group inline-flex items-center space-x-2 space-x-reverse tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-navy-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                        href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li>
                                    <a class="group inline-flex items-center space-x-2 space-x-reverse tracking-wide text-error outline-none"
                                        href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div @click="$dispatch('show-drawer', { drawerId: 'kanban-setting-drawer' })"
        class="fixed left-3 bottom-3 rounded-full bg-white dark:bg-navy-700">
        <button
