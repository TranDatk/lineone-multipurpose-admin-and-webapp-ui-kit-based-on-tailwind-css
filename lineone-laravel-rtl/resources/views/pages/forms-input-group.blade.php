                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-4">
                        <div>
                            ...
                            <label class="mt-1.5 flex -space-x-px space-x-reverse">
                                <span
                        ...
                        <div>
                            ...
                            <label class="mt-1 flex -space-x-px space-x-reverse">
                                <span
                                    class="flex items-center justify-center rounded-r-lg border border-slate-300 px-3.5 font-inter dark:border-navy-450">
                                    <span>$</span>
                                </span>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <select
                                class="form-select rounded-r-full border border-slate-300 bg-white px-3 py-2 pl-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                <option>$</option>
                                <option>£</option>
                                <option>€</option>
                            </select>
                            ...
                            <button
                                class="btn rounded-l-full bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                                Purchase
                            </button>
                        </div>
                        <div class="relative flex -space-x-px space-x-reverse">
                            <input
                                class="form-input peer w-full rounded-r-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                            ...
                            <div
                                ...
                                <svg fill="none" stroke="currentColor"
                                    class="size-5 transition-colors duration-200" viewBox="0 0 24 24">
                ...
                <div dir="ltr" class="code-wrapper hidden pt-4">
                    <pre class="is-scrollbar-hidden max-h-96 overflow-auto rounded-lg" x-init="hljs.highlightElement($el)">
              <code class="language-html" x-ignore>
&lt;div&#13;&#10;    x-data=&quot;{&#13;&#10;        config:{&#13;&#10;            numeral: true,&#13;&#10;            numeralThousandsGroupStyle: &apos;thousand&apos;&#13;&#10;        }&#13;&#10;    }&quot;&#13;&#10;    class=&quot;mt-5&quot;&#13;&#10;  &gt;&#13;&#10;    &lt;div class=&quot;flex space-x-reverse -space-x-px&quot;&gt;&#13;&#10;      &lt;select&#13;&#10;        class=&quot;form-select rounded-r-full border border-slate-300 bg-white px-3 py-2 pl-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;        x-model=&quot;config.numeralThousandsGroupStyle&quot;&#13;&#10;      &gt;&#13;&#10;        &lt;option value=&quot;thousand&quot;&gt;Thousands&lt;/option&gt;&#13;&#10;        &lt;option value=&quot;lakh&quot;&gt;Indian lakh&lt;/option&gt;&#13;&#10;        &lt;option value=&quot;wan&quot;&gt;Chinese wan&lt;/option&gt;&#13;&#10;      &lt;/select&gt;&#13;&#10;&#13;&#10;      &lt;input&#13;&#10;        x-input-mask=&quot;config&quot;&#13;&#10;        class=&quot;form-input w-full rounded-l-full border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;        placeholder=&quot;Enter Phone&quot;&#13;&#10;        type=&quot;text&quot;&#13;&#10;      /&gt;&#13;&#10;    &lt;/div&gt;&#13;&#10;  &lt;/div&gt;&#13;&#10;                </code>
            </pre>
                </div>
            </div>
        </div>
