<x-app-layout title="Author Dashboard" is-header-blur="true">
    ...
    <main class="main-content w-full pb-8">
        <div
            class="mt-6 flex flex-col items-center justify-between space-y-2 px-[var(--margin-x)] text-center transition-all duration-[.25s] sm:flex-row sm:space-y-0 sm:text-right">
            <div>
        ...
        <div
            ...
            <div class="card p-4 sm:col-span-2 sm:p-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                    <div
                        class="flex items-center space-x-4 space-x-reverse rounded-2xl border border-slate-150 p-4 dark:border-navy-600">
                        <div
            ...
            <div class="card">
                <div class="mt-3.5 flex grow items-baseline justify-between px-4 sm:px-5">
                    ...
                    <div
                        class="badge space-x-1 space-x-reverse rounded-full bg-success/10 py-1 px-1.5 text-success dark:bg-success/15">
                ...
                <div class="ax-transparent-gridline">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogVisitors);
            ...
            <div class="card">
                <div class="mt-3.5 flex grow items-baseline justify-between px-4 sm:px-5">
                    ...
                    <div
                        class="badge space-x-1 space-x-reverse rounded-full bg-error/10 py-1 px-1.5 text-error dark:bg-error/15">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                ...
                <div class="ax-transparent-gridline">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogMembers);
                        $el._x_chart.render() });"></div>
                </div>
            </div>
        </div>
        <div class="mt-4 sm:mt-5 lg:mt-6">
            ...
            <div class="mt-3 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                <div class="mt-4 hidden pr-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-3 lg:flex">
                ...
                <div
                    ...
                    <div class="card w-64 shrink-0 pb-3">
                        ...
                        <div class="px-4 py-2 sm:px-5">
                            ...
                            <div class="mt-1 flex items-center space-x-4 space-x-reverse">
                                <div class="w-9/12">
                                    <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogAuthors1);
                                        $el._x_chart.render() });"></div>
                                </div>
                    ...
                    <div class="card w-64 shrink-0 pb-3">
                        ...
                        <div class="px-4 py-2 sm:px-5">
                            ...
                            <div class="mt-1 flex items-center space-x-4 space-x-reverse">
                                <div class="w-9/12">
                                    <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogAuthors2);
                                        $el._x_chart.render() });"></div>
                                </div>
                                <div class="w-3/12 text-center">
                                    <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                    ...
                    <div class="card w-64 shrink-0 pb-3">
                        ...
                        <div class="px-4 py-2 sm:px-5">
                            ...
                            <div class="mt-1 flex items-center space-x-4 space-x-reverse">
                                <div class="w-9/12">
                                    <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogAuthors3);
                                        $el._x_chart.render() });"></div>
                                </div>
                                <div class="w-3/12 text-center">
                                    <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                    ...
                    <div class="card w-64 shrink-0 pb-3">
                        ...
                        <div class="px-4 py-2 sm:px-5">
                            ...
                            <div class="mt-1 flex items-center space-x-4 space-x-reverse">
                                <div class="w-9/12">
                                    <div class="ax-transparent-gridline" x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.blogAuthors4);
                                        $el._x_chart.render() });"></div>
                                </div>
                                <div class="w-3/12 text-center">
                                    <p class="text-xl font-medium text-slate-700 dark:text-navy-100">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="card -mt-8 grow rounded-2xl p-4">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <a href="#"
                                class="flex items-center space-x-2 space-x-reverse text-xs hover:text-slate-800 dark:hover:text-navy-100">
                            ...
                            <p
                                class="flex shrink-0 items-center space-x-1.5 space-x-reverse text-slate-400 dark:text-navy-300">
