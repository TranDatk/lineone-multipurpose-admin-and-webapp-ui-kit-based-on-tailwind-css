                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
                    <div class="card bg-gradient-to-r from-blue-500 to-indigo-600 px-5 pb-5">
                        <div>
                            <div class="ax-transparent-gridline mt-5 w-1/2">
                                <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.earningWhite);
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:col-span-2 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                        <div class="card justify-center p-4.5">
                            ...
                            <div>
                                <div
                                    class="badge mt-2 space-x-1 space-x-reverse bg-success/10 py-1 px-1.5 text-success dark:bg-success/15">
                                    <span>10%</span>
                        ...
                        <div class="card justify-center p-4.5">
                            ...
                            <div>
                                <div
                                    class="badge mt-2 space-x-1 space-x-reverse bg-error/10 py-1 px-1.5 text-error dark:bg-error/15">
                                    <span>6%</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                ...
                <div>
                    ...
                    <div class="mt-3 space-y-3.5">
                        <div class="card p-3">
                            ...
                            <p class="-mt-3 text-left text-xs font-medium text-primary dark:text-accent-light">
                                24%
                            </p>
                        ...
                        <div class="card p-3">
                            ...
                            <p class="-mt-3 text-left text-xs font-medium text-secondary dark:text-secondary-light">
                                56%
                            </p>
                        ...
                        <div class="card p-3">
                            ...
                            <p class="-mt-3 text-left text-xs font-medium text-warning">
                                64%
                            </p>
                        ...
                        <div class="card p-3">
                            ...
                            <p class="-mt-3 text-left text-xs font-medium text-info">
                                14%
                            </p>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-1 lg:gap-6">
                    <div class="card px-4 pb-4 sm:px-5">
                        ...
                        <div class="space-y-4">
                            <div class="flex cursor-pointer items-center justify-between space-x-2 space-x-reverse">
                                <div class="flex items-center space-x-3 space-x-reverse">
                                    <div class="avatar">
                                        <img class="rounded-full" src="{{ asset('images/200x200.png') }}"
                                            alt="avatar" />
                    ...
                    <div class="card">
                        ...
                        <div class="ax-transparent-gridline pr-2">
                            <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el, pages.charts.incomePersonal);
                                $el._x_chart.render() });"></div>
                        </div>
                    </div>
                    <div class="card p-4">
                        <div class="space-y-1 text-center font-inter text-xs+">
                            <div class="flex items-center justify-between px-2 pb-4">
                                ...
                                <div class="-ml-1.5 flex space-x-2 space-x-reverse">
                                    <button
                                        class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
