                ...
                <div class="mt-3 flex flex-col justify-between space-y-4">
                    <div class="card p-4">
                        ...
                        <div class="mt-2 flex items-end justify-between">
                            <p class="flex items-center space-x-reverse space-x-2 text-slate-400 dark:text-navy-300">
                                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="card p-2.5">
                        <div class="flex justify-between space-x-reverse space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                ...
                                <div class="flex items-center space-x-reverse space-x-2 text-xs">
                                    <div class="flex shrink-0 items-center space-x-reverse space-x-1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-4.5 text-slate-400 dark:text-navy-300" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
