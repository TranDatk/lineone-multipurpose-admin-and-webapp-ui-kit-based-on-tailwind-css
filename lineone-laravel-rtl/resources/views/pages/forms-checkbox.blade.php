            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 grid grid-cols-2 place-items-start gap-6 sm:grid-cols-3">
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input checked
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 checked:border-slate-500 checked:bg-slate-500 hover:border-slate-500 focus:border-slate-500 dark:border-navy-400 dark:checked:bg-navy-400"
                                type="checkbox" />
                            <span>Default</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                        ...
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-4.5 rounded border-slate-400/70 checked:border-secondary checked:bg-secondary hover:border-secondary focus:border-secondary dark:border-navy-400 dark:checked:border-secondary-light dark:checked:bg-secondary-light dark:hover:border-secondary-light dark:focus:border-secondary-light"
                                type="checkbox" />
                            <span>Secondary</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 checked:!border-info checked:bg-info hover:!border-info focus:!border-info dark:border-navy-400"
                                type="checkbox" />
                            <span>Info</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                        ...
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 checked:!border-warning checked:bg-warning hover:!border-warning focus:!border-warning dark:border-navy-400"
                                type="checkbox" />
                            <span>Warning</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 grid grid-cols-2 place-items-start gap-6 sm:grid-cols-3">
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input checked
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:border-slate-500 checked:bg-slate-500 hover:border-slate-500 focus:border-slate-500 dark:border-navy-500 dark:bg-navy-900 dark:checked:border-navy-400 dark:checked:bg-navy-400"
                                type="checkbox" />
                            <span>Default</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-500 dark:bg-navy-900 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent"
                                type="checkbox" />
                            <span>Primary</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:border-secondary checked:bg-secondary hover:border-secondary focus:border-secondary dark:border-navy-500 dark:bg-navy-900 dark:checked:border-secondary-light dark:checked:bg-secondary-light dark:hover:border-secondary-light dark:focus:border-secondary-light"
                                type="checkbox" />
                            <span>Secondary</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:!border-info checked:!bg-info hover:!border-info focus:!border-info dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Info</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:!border-success checked:!bg-success hover:!border-success focus:!border-success dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Success</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:!border-warning checked:!bg-warning hover:!border-warning focus:!border-warning dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Warning</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-5 rounded border-slate-400/70 bg-slate-100 checked:!border-error checked:!bg-error hover:!border-error focus:!border-error dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Error</span>
                        </label>
                    </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 grid grid-cols-2 place-items-start gap-6 sm:grid-cols-3">
                        ...
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-outline size-5 rounded border-slate-400/70 bg-slate-100 before:bg-secondary checked:border-secondary hover:border-secondary focus:border-secondary dark:border-navy-500 dark:bg-navy-900 dark:before:bg-secondary-light dark:checked:border-secondary-light dark:hover:border-secondary-light dark:focus:border-secondary-light"
                                type="checkbox" />
                            <span>Secondary</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-outline size-5 rounded border-slate-400/70 bg-slate-100 before:!bg-info checked:!border-info hover:!border-info focus:!border-info dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Info</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-outline size-5 rounded border-slate-400/70 bg-slate-100 before:!bg-success checked:!border-success hover:!border-success focus:!border-success dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Success</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-outline size-5 rounded border-slate-400/70 bg-slate-100 before:!bg-warning checked:!border-warning hover:!border-warning focus:!border-warning dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Warning</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-outline size-5 rounded border-slate-400/70 bg-slate-100 before:!bg-error checked:!border-error hover:!border-error focus:!border-error dark:border-navy-500 dark:bg-navy-900"
                                type="checkbox" />
                            <span>Error</span>
                        </label>
                    </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="inline-space mt-5 flex flex-wrap items-center">
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input checked
                                class="form-checkbox is-basic size-3 rounded border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent"
                                type="checkbox" />
                            <span>1</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-3.5 rounded border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent"
                                type="checkbox" />
                            <span>2</span>
                        </label>
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                        ...
                        <label class="inline-flex items-center space-x-2 space-x-reverse">
                            <input
                                class="form-checkbox is-basic size-6 rounded border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent"
                                type="checkbox" />
                            <span>6</span>
                        </label>
                    </div>
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5" x-data="{ selectedFruits: ['apple'] }">
                        <div class="inline-space">
                            <label class="inline-flex items-center space-x-2 space-x-reverse">
                                <input x-model="selectedFruits" value="apple"
                                    class="form-checkbox is-outline size-5 rounded-full border-slate-400/70 before:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:before:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent"
                                    type="checkbox" />
                                <span>Apple</span>
                            </label>
                            <label class="inline-flex items-center space-x-2 space-x-reverse">
                                <input x-model="selectedFruits" value="pineapple"
                                    class="form-checkbox is-outline size-5 rounded-full border-slate-400/70 before:bg-secondary checked:border-secondary hover:border-secondary focus:border-secondary dark:border-navy-400 dark:before:bg-secondary-light dark:checked:border-secondary-light dark:hover:border-secondary-light dark:focus:border-secondary-light"
                                    type="checkbox" />
                                <span>PineApple</span>
                            </label>
                            <label class="inline-flex items-center space-x-2 space-x-reverse">
                                <input x-model="selectedFruits" value="strawberry"
                                    class="form-checkbox is-outline size-5 rounded-full border-slate-400/70 before:!bg-info checked:!border-info hover:!border-info focus:!border-info dark:border-navy-400"
                                    type="checkbox" />
                                <span>Strawberry</span>
                            </label>
                            <label class="inline-flex items-center space-x-2 space-x-reverse">
                                <input x-model="selectedFruits" value="orange"
                                    class="form-checkbox is-outline size-5 rounded-full border-slate-400/70 before:!bg-success checked:!border-success hover:!border-success focus:!border-success dark:border-navy-400"
                                    type="checkbox" />
                                <span>Orange</span>
                            </label>
