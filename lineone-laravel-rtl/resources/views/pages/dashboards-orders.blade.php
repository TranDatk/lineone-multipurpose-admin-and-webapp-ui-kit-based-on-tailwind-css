        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card col-span-12 lg:col-span-8">
                <div class="mt-3 flex flex-col justify-between px-4 sm:flex-row sm:items-center sm:px-5">
                    <div class="flex flex-1 items-center justify-between space-x-2 space-x-reverse sm:flex-initial">
                    ...
                    <div class="hidden space-x-2 space-x-reverse sm:flex" x-data="{ activeTab: 'tabYearly' }">
            ...
            <div
                ...
                <div class="card col-span-2 px-4 pb-5 sm:px-5">
                    ...
                    <div class="flex grow space-x-5 space-x-reverse">
                ...
                <div class="card">
                    <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
                        ...
                        <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                            class="inline-flex">
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="btn -ml-2 size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" />
                ...
                <div class="scrollbar-sm flex space-x-3 space-x-reverse overflow-x-auto px-4 pb-3 sm:px-5">
                    <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                        ...
                        <div class="mt-5">
                            <div>
                                <p>Sales</p>
                                <div class="mt-0.5 flex space-x-2 space-x-reverse">
                                    <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                                        2 348
                                    </p>
                                    <p class="flex items-center space-x-0.5 space-x-reverse text-xs text-success">
                        ...
                        <div class="mt-5 flex justify-center space-x-2 space-x-reverse">
                            <button
                        ...
                        <div class="mt-5">
                            <div>
                                ...
                                <div class="mt-0.5 flex space-x-2 space-x-reverse">
                                    ...
                                    <p class="flex items-center space-x-0.5 space-x-reverse text-xs text-error">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="mt-5 space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2 space-x-reverse">
                                <img class="size-6" src="{{ asset('images/200x200.png') }}"
                                    alt="flag" />
                                <p>Instagram</p>
                            </div>
                            <div class="flex items-center space-x-2 space-x-reverse">
                        ...
                        <table class="is-hoverable w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge space-x-2.5 space-x-reverse text-xs+ text-warning">
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge space-x-2.5 space-x-reverse text-xs+ text-success">
                                            <div class="size-2 rounded-full bg-current"></div>
                                            <span>Paid</span>
                                        </div>
                                    </td>
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge space-x-2.5 space-x-reverse text-xs+ text-error">
                                            <div class="size-2 rounded-full bg-current"></div>
                                            <span>Failed</span>
                                        </div>
                                    </td>
