            ...
            <div class="card">
                ...
                <div class="flex grow flex-col p-4">
                    ...
                    <div class="mt-3 text-right">
                        <button
                            class="btn h-8 space-x-1.5 space-x-reverse rounded-full bg-slate-150 px-3 text-xs+ font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
