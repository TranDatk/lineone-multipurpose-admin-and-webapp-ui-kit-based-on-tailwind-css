<x-app-layout title="Jobs Board" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between space-x-2 py-5 space-x-reverse">
            ...
            <div>
                <a href="#"
                    class="border-b border-dashed border-current pb-0.5 font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70">Create
                    Resume</a>
            </div>
        </div>
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="col-span-12 sm:order-last sm:col-span-7 sm:mr-4 lg:col-span-8 xl:col-span-9">
                <div class="flex items-center justify-between space-x-3 sm:space-x-5 space-x-reverse sm:space-x-reverse">
                    <div class="flex w-full max-w-lg">
                        <label class="relative flex w-full">
                            <input
                                class="form-input peer h-9 w-full rounded-r-lg bg-white px-3 py-2 shadow-soft ring-primary/50 placeholder:text-slate-400 focus:ring dark:bg-navy-700 dark:shadow-none dark:ring-accent/50 dark:placeholder:text-navy-300 lg:pr-9"
                        ...
                        <button
                            class="btn h-9 rounded-r-none bg-primary px-3 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90 lg:px-5">
                    ...
                    <div class="card p-5">
                        <div>
                            ...
                            <div class="mt-3 space-y-2 text-xs+">
                                <p class="flex space-x-2 space-x-reverse">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="mt-5 flex justify-between">
                            <button
                                class="btn h-9 bg-primary text-xs+ font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                Apply Now
                            </button>
                            <button
            ...
            <div class="col-span-12 sm:col-span-5 lg:col-span-4 xl:col-span-3">
                            ...
                            <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                                <div
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"
                                                class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">USD</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">EUR
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">CAD
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-3 space-y-2.5">
                        <div class="flex items-center justify-between">
                            <label class="inline-flex items-center space-x-2 space-x-reverse">
                                <input
                                    class="form-checkbox is-outline h-5 w-5 rounded border-slate-400/70 bg-white before:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:before:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent"
                                    type="checkbox" />
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-5">
                        <a href="#" class="card items-center justify-center px-2 py-4 text-center text-xs+">
                            <img class="h-12 w-12" src="{{ asset('images/200x200.png') }}" alt="image" />
