                    ...
                    <table class="is-zebra w-full text-right">
                        <thead>
                            <tr>
                                ...
                                <th
                                    class="whitespace-nowrap rounded-l-lg bg-slate-200 px-3 py-3 text-right font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                                    SUBTOTAL
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="w-3/12 whitespace-nowrap px-4 py-3 text-left sm:px-5">
                                    10
                                </td>
                                <td class="w-3/12 whitespace-nowrap px-4 py-3 text-left sm:px-5">
                                    55
                                ...
                                <td
                                    class="w-3/12 whitespace-nowrap rounded-l-lg px-4 py-3 text-left font-semibold sm:px-5">
                                    550
                                </td>
                            </tr>
                            <tr>
