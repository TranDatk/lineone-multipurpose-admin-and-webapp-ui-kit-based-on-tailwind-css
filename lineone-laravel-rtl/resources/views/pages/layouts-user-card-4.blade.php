    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
            <div class="card items-center justify-between lg:flex-row">
                <div
                    class="flex flex-col items-center lg:space-x-4 lg:space-x-reverse p-4 text-center sm:p-5 lg:flex-row lg:text-left">
            ...
            <div class="card items-center justify-between lg:flex-row">
                <div
                    class="flex flex-col items-center lg:space-x-4 lg:space-x-reverse p-4 text-center sm:p-5 lg:flex-row lg:text-right">
                    <div class="avatar size-18 lg:h-12 lg:w-12">
                        <img class="rounded-full" src="{{ asset('images/200x200.png') }}" alt="avatar" />
                    </div>
                    <div class="mt-2 lg:mt-0">
