<x-base-layout title="Todo Application" is-sidebar-open="true" is-header-blur="true" has-min-sidebar="true">
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="is-scrollbar-hidden grow overflow-y-auto">
                        ...
                        <ul class="mt-5 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg bg-primary/10 p-2 tracking-wide text-primary outline-none transition-all dark:bg-accent-light/10 dark:text-accent-light"
                                    href="#">
                            ...
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide text-error outline-none transition-all hover:bg-error/20 focus:bg-error/20"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <ul class="mt-1 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-success/20 focus:bg-success/20"
                                    href="#">
                            ...
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-warning/20 focus:bg-warning/20"
                                    href="#">
                            ...
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-error/20 focus:bg-error/20"
                                    href="#">
                            ...
                            <li>
                                <a class="group flex space-x-2 space-x-reverse rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-info/20 focus:bg-info/20"
                                    href="#">
            ...
            <div x-show="!isSearchbarActive" class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 space-x-reverse">
                    <label class="relative hidden sm:flex">
                        <input
                            class="form-input peer h-9 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
        ...
        <div class="card px-4 pt-2 pb-4">
            <div x-init="Sortable.create($el, {
                ...
                <div class="border-b border-slate-150 py-3 dark:border-navy-500"
                    ...
                    <div class="flex items-center space-x-2 space-x-reverse sm:space-x-3 sm:space-x-reverse">
                        <label class="flex">
                    ...
                    <div class="mt-1 flex items-end justify-between">
                        <div class="flex flex-wrap items-center font-inter text-xs">
                            ...
                            <div class="m-1.5 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <div class="badge space-x-2.5 space-x-reverse px-1 text-success">
                ...
                <div class="border-b border-slate-150 py-3 dark:border-navy-500"
                    ...
                    <div class="mt-1 flex items-end justify-between">
                        <div class="flex flex-wrap items-center font-inter text-xs">
                            ...
                            <div class="m-1.5 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <div class="badge space-x-2.5 space-x-reverse px-1 text-warning">
                                <div class="size-2 rounded-full bg-current"></div>
                                <span>Medium</span>
                            </div>
                            <div class="m-1.5 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <div class="badge space-x-2.5 space-x-reverse px-1 text-info">
                                <div class="size-2 rounded-full bg-current"></div>
                                <span>Update</span>
                            </div>
                        </div>
                ...
                <div class="border-b border-slate-150 py-3 dark:border-navy-500"
                    ...
                    <div class="mt-1 flex items-end justify-between">
                        <div class="flex flex-wrap items-center font-inter text-xs">
                            ...
                            <div class="m-1.5 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <div class="badge space-x-2.5 space-x-reverse px-1 text-error">
                                <div class="size-2 rounded-full bg-current"></div>
                                <span>High</span>
                            </div>
                        </div>
    ...
    <div x-show="showDrawer" x-data="{ showDrawer: false }"
        ...
        <div class="fixed left-0 top-0 z-[101] h-full w-80">
            <div class="flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200 dark:bg-navy-700"
                ...
                <div class="flex h-14 items-center justify-between bg-slate-150 p-4 dark:bg-navy-800">
                    ...
                    <div class="-ml-1.5 flex items-center space-x-2.5 space-x-reverse">
