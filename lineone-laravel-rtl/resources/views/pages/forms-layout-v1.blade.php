                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label class="block">
                                ...
                                <span class="relative mt-1.5 flex">
                                    <input
                                        class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="Your City/Town" type="text" />
                                    <span
                                        class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                            ...
                            <label class="block">
                                ...
                                <span class="relative mt-1.5 flex">
                                    <input
                                        class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="Your State" type="text" />
                                    <span
                                        class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                        ...
                        <div x-data="{ sameBillingAddress: true }">
                            <div
                                class="flex-wrap items-start space-y-2 pt-2 sm:flex sm:space-y-0 sm:space-x-5 sm:space-x-reverse">
                                ...
                                <div>
                                    <button @click="sameBillingAddress = false"
                ...
                <div class="sticky top-24 mt-3">
                    <ol class="steps is-vertical line-space">
                        <li class="step pb-8 before:bg-primary dark:before:bg-accent">
                            ...
                            <h3 class="mr-4 text-slate-700 dark:text-navy-100">
                                Create Account
                            </h3>
                        </li>
                        <li class="step pb-8 before:bg-primary dark:before:bg-accent">
                        ...
                        <li class="step pb-8 before:bg-slate-200 dark:before:bg-navy-500">
                            ...
                            <h3 class="mr-4 text-slate-700 dark:text-navy-100">Submit</h3>
                        </li>
                    </ol>
                </div>
            </div>
