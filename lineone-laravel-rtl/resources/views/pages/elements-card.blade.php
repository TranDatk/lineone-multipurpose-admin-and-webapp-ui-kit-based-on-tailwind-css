<x-app-layout title="Card Element" is-sidebar-open="true" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            ...
            <div class="rounded-lg bg-primary px-4 py-4 text-white dark:bg-accent sm:px-5">
                <div>
            ...
            <div class="rounded-lg bg-warning px-4 py-4 text-white shadow-lg shadow-warning/50 sm:px-5">
                <div>
                    <h2 class="text-lg font-medium tracking-wide line-clamp-1">
                        Glow Card
                    </h2>
            ...
            <div class="rounded-lg bg-info px-4 py-4 text-white shadow-lg shadow-info/50 sm:px-5">
                <div>
                    <h2 class="text-lg font-medium tracking-wide line-clamp-1">
                        Glow Card
                    </h2>
            ...
            <div class="rounded-lg bg-gradient-to-br from-amber-400 to-orange-600 px-4 py-4 text-white sm:px-5">
                <div>
                    <h2 class="text-lg font-medium tracking-wide line-clamp-1">
                        Gradient Card
                    </h2>
            ...
            <div class="rounded-lg bg-gradient-to-r from-amber-400 to-orange-600 p-1">
                <div class="rounded-lg bg-slate-50 px-4 py-4 dark:bg-navy-900 sm:px-5">
                    <div>
                        <h2 class="text-lg font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100">
                            Outlined Gradient
