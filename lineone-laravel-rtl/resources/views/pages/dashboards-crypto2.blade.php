                ...
                <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
                    <div :class="$store.breakpoints.smAndUp && 'card px-5 pb-3'">
                        <div class="flex items-center justify-between sm:py-3">
                            ...
                            <div class="flex space-x-4 space-x-reverse font-inter text-slate-700 dark:text-navy-100"
                                x-data="{ activeTab: '12hr' }">
                                <div
                                    class="hidden w-full justify-between space-x-4 space-x-reverse font-inter text-slate-700 dark:text-navy-100 sm:flex">
                                ...
                                <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                    ...
                                    <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                        class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:-ml-1.5">
                    ...
                    <div class="card px-4 pb-4 sm:px-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div
                                class="flex items-center justify-between space-x-2 space-x-reverse rounded-lg border border-slate-200 p-3 dark:border-navy-600">
