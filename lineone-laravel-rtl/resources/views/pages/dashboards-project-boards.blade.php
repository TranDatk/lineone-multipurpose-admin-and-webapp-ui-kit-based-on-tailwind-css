<x-app-layout title="Project Board" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div
            class="mt-6 flex flex-col items-center justify-between space-y-2 text-center sm:flex-row sm:space-y-0 sm:text-right">
            <div>
            ...
            <button
                class="btn space-x-2 space-x-reverse bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
            ...
            <div class="card shadow-none">
                <div class="flex flex-1 flex-col justify-between rounded-lg bg-warning p-4 sm:p-5">
                    ...
                    <div>
                        ...
                        <div class="mt-5 flex flex-wrap -space-x-3 space-x-reverse">
                        ...
                        <div class="mt-4 flex items-center justify-between space-x-2 space-x-reverse">
