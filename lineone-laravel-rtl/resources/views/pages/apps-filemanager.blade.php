<x-base-layout title="File Manager" is-sidebar-open="true" is-header-blur="true" has-min-sidebar="true">
                                ...
                                <ul class="mt-1 space-y-1 px-2 font-inter text-xs+ font-medium">
                                    <li x-data="{ expanded: false }">
                                        <div tabindex="0"
                                            ...
                                            <button @click="expanded = !expanded"
                                                class="btn ml-1 size-5 rounded-lg p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-3 size-6 text-warning"
                                        ...
                                        <ul x-show="expanded" x-collapse class="pr-4">
                                            <li>
                                                <div tabindex="0"
                                                    class="flex cursor-pointer items-center rounded px-2 py-1 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:text-navy-100 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">
                                                    <div class="mr-1 flex size-5 items-center justify-center"></div>
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="ml-3 size-6 text-warning" viewBox="0 0 20 20"
                                                        fill="currentColor">
                                                        <path
                                                            d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                                                    </svg>
    ...
    <main class="main-content filemanager-app w-full pb-6">
        <div
            class="flex items-center justify-between space-x-2 space-x-reverse px-[var(--margin-x)] pb-4 pt-5 transition-all duration-[.25s]">
        ...
        <div class="flex flex-col" x-data="{ activeTab: 'tab-recent' }">
            <div class="flex space-x-2 space-x-reverse px-[var(--margin-x)] transition-all duration-[.25s]">
