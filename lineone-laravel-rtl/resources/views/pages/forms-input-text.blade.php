                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        <label class="block">
                            <input
                                class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="Choose browser" type="text" list="browsers" />
                        ...
                        <div>
                            <label class="block">
                                <input
                                    ...
                                    placeholder="Username" type="text" value="Some Value" />
                            </label>
                ...
                <div class="max-w-xl">
                    ...
                    <div x-data="{ debounceText: '' }" class="mt-5">
                        <label class="block">
                            <input
                                class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="Username" type="text" x-model.debounce="debounceText" />
                        </label>
                ...
                <div class="max-w-xl">
                    ...
                    <div x-data="{ lazyText: '' }" class="mt-5">
                        <label class="block">
                            <input
                                class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="Username" type="text" x-model.lazy="lazyText" />
                        </label>
