            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-3.5 font-inter font-medium">
                            <li>
                                <a class="inline-flex items-center space-x-2 space-x-reverse tracking-wide text-primary outline-none dark:text-accent-light"
                                    href="#">
                            ...
                            <li>
                                <a class="group inline-flex items-center space-x-2 space-x-reverse tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-primary px-4 py-2.5 tracking-wide text-white outline-none transition-all dark:bg-accent"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex rounded-lg px-4 py-2.5 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
                                    href="#">
                                    <span>Shipping</span>
                                </a>
                            </li>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-full bg-primary px-5 py-2.5 tracking-wide text-white outline-none transition-all dark:bg-accent"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex rounded-full px-5 py-2.5 tracking-wide outline-none transition-all hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary dark:hover:bg-accent-light/15 dark:hover:text-accent-light dark:focus:bg-accent-light/15 dark:focus:text-accent-light"
                                    href="#">
                                    <span>Shipping</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex items-center space-x-2 space-x-reverse rounded-full bg-primary px-5 py-2.5 tracking-wide text-white outline-none transition-all dark:bg-accent"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-slate-150 px-4 py-2.5 tracking-wide text-slate-800 outline-none transition-all dark:bg-navy-500 dark:text-navy-50"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a href="#"
                                    class="flex space-x-2 space-x-reverse rounded-lg bg-slate-150 px-4 py-2.5 tracking-wide text-slate-800 outline-none transition-all dark:bg-navy-500 dark:text-navy-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg bg-slate-150 bg-gradient-to-r from-purple-500 to-purple-600 px-4 py-2.5 tracking-wide text-white outline-none transition-all"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a href="#"
                                    class="flex space-x-2 space-x-reverse rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 px-4 py-2.5 tracking-wide text-white outline-none transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a class="flex rounded-lg border border-slate-150 px-4 py-2.5 tracking-wide text-primary shadow-sm outline-none transition-all dark:border-navy-500 dark:text-accent-light"
                                    href="#">
                                    <span>Getting start</span>
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="p-4 sm:px-5">
                        <ul class="space-y-1.5 font-inter font-medium">
                            <li>
                                <a href="#"
                                    class="flex space-x-2 space-x-reverse rounded-lg border border-slate-150 px-4 py-2.5 tracking-wide text-primary shadow-sm outline-none transition-all dark:border-navy-500 dark:text-accent-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
