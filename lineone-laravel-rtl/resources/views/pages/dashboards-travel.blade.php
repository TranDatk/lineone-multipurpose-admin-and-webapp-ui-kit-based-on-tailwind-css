<x-app-layout title="Travel Dashboard" is-header-blur="true">
    ...
    <main class="main-content w-full pb-8">
        ...
        <div class="mt-4 pr-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 lg:mt-6">
            <div class="rounded-r-lg bg-slate-150 pt-4 pb-1 dark:bg-navy-800">
                <h2
                    class="px-4 text-base font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100 sm:px-5 lg:text-lg">
                    Top Hotels
                </h2>
                <div class="scrollbar-sm mt-4 flex space-x-4 space-x-reverse overflow-x-auto px-4 pb-4 sm:px-5">
