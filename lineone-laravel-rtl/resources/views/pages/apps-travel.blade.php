<x-app-layout title="Travel Application" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between space-x-2 space-x-reverse py-5">
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="col-span-12 lg:col-span-8">
                <div class="flex items-center justify-between space-x-3 space-x-reverse sm:space-x-5 sm:space-x-reverse">
                    ...
                    <div class="card">
                        ...
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between">
                            ...
                            <div
                                ...
                                <div class="mt-1 flex items-center space-x-3 space-x-reverse text-slate-200">
                                    ...
                                    <p class="flex shrink-0 items-center space-x-1 space-x-reverse">
                            ...
                            <div class="flex space-x-4 space-x-reverse">
                                ...
                                <div>
                                    <a href="#"
                                        ...
                                        on forest</a>
                                    <p class="flex items-center space-x-1.5 space-x-reverse text-xs">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-3.5 text-slate-400 dark:text-navy-300" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
