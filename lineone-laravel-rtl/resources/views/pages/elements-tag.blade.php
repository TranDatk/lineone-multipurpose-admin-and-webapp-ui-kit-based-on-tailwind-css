            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div>
                    ...
                    <div class="inline-space mt-5 flex flex-wrap">
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <a href="#"
                                class="tag rounded-l-none bg-info/10 text-info hover:bg-info/20 focus:bg-info/20 active:bg-info/25">
                                Message
                            </a>
                            <a href="#"
                                class="tag rounded-r-none bg-info text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90">
                                65
                            </a>
                        </div>
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <a href="#"
                                class="tag rounded-full rounded-l-none border border-warning text-warning hover:bg-warning/20 focus:bg-warning/20 active:bg-warning/25">
                                Warnings
                            </a>
                            <a href="#"
                                class="tag rounded-full rounded-r-none border border-warning bg-warning/10 text-warning hover:bg-warning/20 focus:bg-warning/20 active:bg-warning/25">
                                35
                            </a>
                        </div>
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <a href="#"
                                class="tag rounded-l-none bg-success/10 text-success hover:bg-success/20 focus:bg-success/20 active:bg-success/25">
                                Message
                            </a>
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <a href="#"
                                class="tag rounded-l-none bg-slate-150 px-4 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                                Star
                            </a>
                            <a href="#"
                        ...
                        <div class="flex -space-x-px space-x-reverse">
                            <div class="badge rounded-l-none border border-error text-error">
                                Remove
                            </div>
                            <a href="#"
                        ...
                        <div
                            class="badge space-x-2 space-x-reverse rounded-full bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100">
                            <i class="fa-solid fa-person-biking text-sm text-slate-600 dark:text-navy-200"></i>
                            <span>Default</span>
                            <button
