<x-app-layout title="Price List 2" is-header-blur="true">
    ...
    <main class="main-content w-full place-items-center px-[var(--margin-x)] pb-12">
        ...
        <div
            class="grid max-w-4xl grid-cols-1 gap-4 divide-y divide-slate-150 bg-white shadow-soft dark:divide-navy-500 dark:bg-navy-700 dark:shadow-none sm:grid-cols-3 sm:gap-5 sm:divide-x sm:divide-y-0 sm:divide-x-reverse lg:gap-6">
