        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                <div class="card items-center p-4 sm:p-5 lg:p-7">
                    ...
                    <div class="mt-6 flex space-x-6 space-x-reverse">
                        <button
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <label class="relative flex">
                    <input
                        class="form-input peer h-9 w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <div class="mt-4 space-y-3.5">
                        <label class="flex items-center justify-between space-x-2 space-x-reverse">
                    ...
                    <button
                        class="btn mt-6 space-x-2 space-x-reverse bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        <div class="space-x-1.5 space-x-reverse">
                            <button
