<x-base-layout title="Starter Centered Links" is-sidebar-open="true" is-header-blur="true">
    ...
    <div class="sidebar print:hidden">
        ...
        <div class="main-sidebar">
            <div
                class="flex h-full w-full flex-col items-center justify-between border-l border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
                <!-- Application Logo -->
                <div class="flex pt-4">
                    <a href="/">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center  space-x-reverse space-x-4 py-5 lg:py-6">
