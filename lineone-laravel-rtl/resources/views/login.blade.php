    ...
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            ...
            <form class="mt-16" action="{{ route('login') }}" method="post">
                ...
                <div class="mt-4 flex items-center justify-between  space-x-reverse space-x-2">
                ...
                <div class="my-7 flex items-center  space-x-reverse space-x-3">
                ...
                <div class="flex space-x-reverse space-x-4">
                    <button
                        class="btn w-full  space-x-reverse space-x-3 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                        <img class="size-5.5" src="{{ asset('images/200x200.png') }}" alt="logo" />
                        <span>Google</span>
                    </button>
                    <button
                        class="btn w-full  space-x-reverse space-x-3 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
